...
var codegenCmd = &cobra.Command{
	Use:   "codegen",
	Short: "Run a benchmark for code generation.",
	Long:  `This command runs a benchmark to test the model's ability to generate code.`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("Running code generation benchmark...")
